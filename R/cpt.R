...
#'
#' Constructs a travelpath specification for change point detection using a permutation test.
#' This function creates a specification object for change point analysis using the
#' `cpt::change_point_test` engine. The method detects change points in a sequence
#' by comparing segments using a specified distance metric and assessing significance
